...
func _() {
	...
	_ = x[AttachCgroupSyscallSocket-58]
	_ = x[AttachCgroupSyscallSocketExit-59]
	_ = x[AttachCgroupSyscallSendmsg-60]
	_ = x[AttachCgroupSyscallSendto-61]
	_ = x[AttachCgroupSyscallRecvmsg-62]
	_ = x[AttachCgroupSyscallRecvmsgExit-63]
	_ = x[AttachCgroupSyscallBind-64]
	_ = x[AttachCgroupSyscallSetsockopt-65]
	_ = x[AttachCgroupSyscallGetsockname-66]
	_ = x[AttachCgroupSyscallConnect-67]
	_ = x[AttachCgroupSyscallAcceptExit-68]
	_ = x[AttachCgroupSyscallUname-69]
...
const (
	...
	_AttachType_name_1 = "CgroupSyscallSocketCgroupSyscallSocketExitCgroupSyscallSendmsgCgroupSyscallSendtoCgroupSyscallRecvmsgCgroupSyscallRecvmsgExitCgroupSyscallBindCgroupSyscallSetsockoptCgroupSyscallGetsocknameCgroupSyscallConnectCgroupSyscallAcceptExitCgroupSyscallUname"
...
var (
	...
	_AttachType_index_1 = [...]uint8{0, 19, 42, 62, 81, 101, 125, 142, 165, 189, 209, 232, 250}
