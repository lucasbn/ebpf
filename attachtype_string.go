...
func _() {
	...
	_ = x[AttachCgroupSyscallSendto-60]
	_ = x[AttachCgroupSyscallRecvmsg-61]
	_ = x[AttachCgroupSyscallRecvmsgExit-62]
	_ = x[AttachCgroupSyscallBind-63]
	_ = x[AttachCgroupSyscallSetsockopt-64]
	_ = x[AttachCgroupSyscallGetsockname-65]
	_ = x[AttachCgroupSyscallConnect-66]
	_ = x[AttachCgroupSyscallAcceptExit-67]
...
const (
	...
	_AttachType_name_1 = "CgroupSyscallSocketCgroupSyscallSocketExitCgroupSyscallSendtoCgroupSyscallRecvmsgCgroupSyscallRecvmsgExitCgroupSyscallBindCgroupSyscallSetsockoptCgroupSyscallGetsocknameCgroupSyscallConnectCgroupSyscallAcceptExit"
...
var (
	...
	_AttachType_index_1 = [...]uint8{0, 19, 42, 61, 81, 105, 122, 145, 169, 189, 212}
