...
const (
	...
	BPF_CGROUP_SYSCALL_SOCKET          AttachType = 58
	BPF_CGROUP_SYSCALL_SOCKET_EXIT     AttachType = 59
	BPF_CGROUP_SYSCALL_SENDMSG         AttachType = 60
	BPF_CGROUP_SYSCALL_SENDTO          AttachType = 61
	BPF_CGROUP_SYSCALL_RECVMSG         AttachType = 62
	BPF_CGROUP_SYSCALL_RECVMSG_EXIT    AttachType = 63
	BPF_CGROUP_SYSCALL_BIND            AttachType = 64
	BPF_CGROUP_SYSCALL_SETSOCKOPT      AttachType = 65
	BPF_CGROUP_SYSCALL_GETSOCKNAME     AttachType = 66
	BPF_CGROUP_SYSCALL_CONNECT         AttachType = 67
	BPF_CGROUP_SYSCALL_ACCEPT_EXIT     AttachType = 68
	BPF_CGROUP_SYSCALL_UNAME           AttachType = 69
	__MAX_BPF_ATTACH_TYPE              AttachType = 70
)
...
const (
	...
	BPF_PROG_TYPE_CGROUP_SYSCALL          ProgType = 33
	__MAX_BPF_PROG_TYPE                   ProgType = 34
)
